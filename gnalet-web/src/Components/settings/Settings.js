        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
                ...
                <div className="col-md-10">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <hr />
                      <h6 className="card-subtitle">REPORT CATEGORIES</h6>
                      ...
                      <hr />
                      <h6 className="card-subtitle">REGIONAL JURISDICTIONS</h6>
                      <ul className="list-group">
                        {region.map(reg => {
                          return (
                            <li key={reg} className="list-group-item">
            ...
            <div class="modal-footer">
              <button data-dismiss="modal" class="btn btn-danger mr-auto">
                Delete Account
              </button>
              <button
                type="button"
                ...
                <div className="form-group">
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      name="access"
                      id="rb"
                      value={ACCESS_CODE_EDIT}
                      onChange={this.onChange}
                    />
                    <label className="form-check-label" htmlFor="rb">
                      Responsible Body
                    </label>
                  </div>
                </div>
      ...
      <div className="col-md-7">
        <div className="row">
          ...
          <div className="col-md-2">
            ...
            >
              <i className="fas fa-plus" /> Add Authority
            </div>
          </div>
        </div>
        <br />
            ...
            {authorities.map(authority => {
              return (
                <tr
                  ...
                  onClick={this.openDetail.bind(this, authority)}
                >
                  <th scope="row">
            ...
            >
              <div className="card settings-list">
                ...
                <ul className="list-group list-group-flush">
                  <li
                    className="list-group-item settings-list-item"
                  ...
                  <li className="list-group-item settings-list-item">
                    Signout
                  </li>
                </ul>
              </div>
